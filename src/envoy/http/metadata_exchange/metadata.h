  ...
  namespace Extensions {
    namespace Wasm {
      namespace MetadataExchange {
        ...
        const wasm::metadataexchange::Metadata& localMetadata();

        const wasm::metadataexchange::Metadata& upstreamPeerMetadata();
        const wasm::metadataexchange::Metadata& downstreamPeerMetadata();
      }
    }
  }
}
